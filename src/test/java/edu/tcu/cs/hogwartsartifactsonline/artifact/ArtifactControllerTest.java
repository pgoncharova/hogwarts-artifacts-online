...
class ArtifactControllerTest {
    ...
    void setUp() {
        ...
        a1.setDescription("A Deluminator is a device invented by Albus Dumbledore " +
                "that resembles a cigarette lighter. It is used to remove or absorb " +
                "(as well as return) the light from any light source to provide cover " +
                "to the user.");
        ...
        a3.setDescription("The Elder Wand, known throughout history as the Deathstick " +
                "or the Wand of Destiny, is an extremely powerful wand made of elder " +
        ...
        a4.setDescription("A magical map of Hogwarts created by Remus Lupin, Peter " +
                "Pettigrew, Sirius Black, and James Potter while they were students " +
                "at Hogwarts.");
        ...
        a5.setDescription("A goblin-made sword adorned with large rubies on the pommel. " +
                "It was once owned by Godric Gryffindor, one of the medieval founders of" +
                " Hogwarts.");
        ...
        a6.setDescription("The Resurrection Stone allows the holder to bring back " +
                "deceased loved ones, in a semi-physical form, and communicate with them.");
    ...
    void testUpdateArtifactSuccess() throws Exception {
        // Given
        ArtifactDto artifactDto = new ArtifactDto("1250808601744984192",
                "Invisibility Cloak",
                "A new description.",
                "ImageUrl",
                null);
        ...
        updatedArtifact.setId("1250808601744984192");
        ...
        given(this.artifactService.update(eq("1250808601744984192"),
                Mockito.any(Artifact.class)))
                .willReturn(updatedArtifact);

        // When and then
        this.mockMvc.perform(put(this.baseUrl + "/artifacts/1250808601744984192")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json)
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception {
        ...
        given(this.artifactService.update(eq("1250808601744984192"),
                Mockito.any(Artifact.class)))
                .willThrow(new ObjectNotFoundException("artifact", "1250808601744984192"));
        ...
        this.mockMvc.perform(put(this.baseUrl + "/artifacts/1250808601744984192")
                ...
                .andExpect(jsonPath("$.message").value("Could not find artifact with Id 1250808601744984192 :("))
                .andExpect(jsonPath("$.data")
                        .isEmpty());
    }
